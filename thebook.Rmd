...
plot = ggplot(killsPerRegion, aes(x=région,y=morts))+geom_bar(stat="identity")+ggtitle("Nombre de victimes du terrorisme par région")+xlab("Région")+ylab("Nombre de morts")+theme(axis.text.x = element_text(angle=45))
