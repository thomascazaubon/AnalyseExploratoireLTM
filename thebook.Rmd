...
plot = ggplot(mostTargetedNationality, aes(x=année,y=nationalite))+geom_line()+ggtitle("Evolution du taux de réussite des attentats.")+xlab("Année")+ylab("Taux de réussite")+theme(axis.text.x = element_text(angle=45))
ggsave(plot, filename = "graphiques/mostTargetedNationalityPerYear.pdf", width=4, height=3)
```
...
ggsave(plot, filename = "graphiques/test.pdf", width=4, height=3)
```
